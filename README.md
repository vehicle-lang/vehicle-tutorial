...
- [VETSS Summer School](https://wp.doc.ic.ac.uk/vss/) at the University
  of Surrey, UK; 23 August 2023; [Youtube recording
  available](https://youtu.be/-ZRE1BgaCk0);
...
gives a summary of all tutorial resorces. To cite Vehicle tutorial,
please use:
...
$\mathcal{L}(\hat{\mathbf{x}}, \mathbf{y})$ between the predicted value
...
In Vehicle, given a property
$\forall \mathbf{x}. \mathcal{P}(\mathbf{x}) \Rightarrow \mathcal{S}(\mathbf{x})$,
